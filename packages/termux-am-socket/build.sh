TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/termux-am-socket
...
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/termux-am-socket/archive/refs/tags/${TERMUX_PKG_VERSION}.tar.gz
