TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/termux-exec-package
...
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/termux-exec-package/archive/refs/tags/v${TERMUX_PKG_VERSION:2}.tar.gz
