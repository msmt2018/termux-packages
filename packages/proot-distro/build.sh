TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/proot-distro
TERMUX_PKG_DESCRIPTION="Termux official utility for managing proot'ed Linux distributions"
TERMUX_PKG_LICENSE="GPL-3.0"
TERMUX_PKG_MAINTAINER="@termux"
TERMUX_PKG_VERSION="4.38.0"
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/proot-distro/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
