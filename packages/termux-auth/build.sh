TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/termux-auth
TERMUX_PKG_DESCRIPTION="Password authentication library and utility for Termux"
TERMUX_PKG_LICENSE="GPL-3.0"
TERMUX_PKG_MAINTAINER="@termux"
TERMUX_PKG_VERSION=1.5.0
TERMUX_PKG_REVISION=1
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/termux-auth/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
