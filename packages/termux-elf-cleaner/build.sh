TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/termux-elf-cleaner
...
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/termux-elf-cleaner/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
