TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/libandroid-support
...
TERMUX_PKG_SRCURL=(https://github.com.itsaky.androidide/libandroid-support/archive/refs/tags/v${TERMUX_PKG_VERSION[0]}.tar.gz
                   https://github.com.itsaky.androidide/wcwidth/archive/refs/tags/v${TERMUX_PKG_VERSION[1]}.tar.gz)
