TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/libandroid-shmem
TERMUX_PKG_DESCRIPTION="System V shared memory emulation on Android using ashmem"
TERMUX_PKG_LICENSE="BSD 3-Clause"
TERMUX_PKG_MAINTAINER="@termux"
TERMUX_PKG_VERSION=0.7
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/libandroid-shmem/archive/refs/tags/v${TERMUX_PKG_VERSION}.tar.gz
