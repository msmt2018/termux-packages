...
# https://github.com/msmt2018/termux-packages/issues/22328
# https://github.com/msmt2018/termux-packages/wiki/Common-porting-problems#android-dynamic-linker
# https://github.com/android/ndk/issues/201
#
# Using /data/data/com.itsaky.androidide/files/usr to substitute full path at build time.
