...
termux_step_configure () {
	...
	# such as '-Wl,-rpath,/data/data/com.itsaky.androidide/files/usr/lib'
	# and '-I/data/data/com.itsaky.androidide/files/usr/include/qt6/QtCore',
	# but fails to correctly set some other necessary build settings,
	# like 'aarch64-linux-android-clang++' and '-L/data/data/com.itsaky.androidide/files/usr/lib',
