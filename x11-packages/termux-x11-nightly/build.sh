TERMUX_PKG_HOMEPAGE=https://github.com.itsaky.androidide/termux-x11
TERMUX_PKG_DESCRIPTION="Termux X11 add-on."
TERMUX_PKG_LICENSE="GPL-3.0"
TERMUX_PKG_MAINTAINER="Twaik Yont @twaik"
TERMUX_PKG_VERSION=1.03.01
TERMUX_PKG_REVISION=4
TERMUX_PKG_SRCURL=https://github.com.itsaky.androidide/termux-x11/archive/efb2d97a46adf1657bacf395c38166a648260066.tar.gz
...
termux_step_make_install() {
	...
	local LOADER_URL="https://github.com.itsaky.androidide/termux-x11/releases/download/nightly/termux-x11-nightly-1.03.01-0-any.pkg.tar.xz"
