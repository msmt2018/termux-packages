...
![GitHub repo size](https://img.shields.io/github/repo-size/msmt2018/termux-packages)
[![Packages last build status](https://github.com/msmt2018/termux-packages/actions/workflows/packages.yml/badge.svg?branch=master)](https://github.com/msmt2018/termux-packages/actions)
[![Docker image status](https://github.com/msmt2018/termux-packages/workflows/Docker%20image/badge.svg)](https://hub.docker.com/r/termux/package-builder)
[![Repology metadata](https://github.com.itsaky.androidide/repology-metadata/workflows/Repology%20metadata/badge.svg)](https://repology.org/repository/termux)
...
This project contains scripts and patches to build packages for the [Termux](https://github.com.itsaky.androidide/termux-app)
Android application.

Quick how-to about Termux package management is available at [Package Management](https://github.com/msmt2018/termux-packages/wiki/Package-Management). It also has info on how to fix **`repository is under maintenance or down`** errors when running `apt` or `pkg` commands.

## Contributing

Read [CONTRIBUTING.md](/CONTRIBUTING.md) and [Developer's Wiki](https://github.com/msmt2018/termux-packages/wiki) for more details.

## Community

The Termux Community docs are available [here](https://github.com.itsaky.androidide/termux-community/blob/site/site/pages/en/index.md).

**All our community members must follow the rules that are defined [here](https://github.com.itsaky.androidide/termux-community/blob/site/site/pages/en/rules/index.md) and any [Content Not Allowed](https://github.com.itsaky.androidide/termux-community/blob/site/site/pages/en/rules/index.md#8-content-not-allowed) must not be posted.**
##
